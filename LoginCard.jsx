  ...
  return (
    ...
    <div >
     ...
     <Card sx={{ maxWidth: 345 , marginRight: 20}} className='background'>
      <CardMedia
        ...
        alt="admin"
        height="170"
        image="https://media.istockphoto.com/id/1226883131/photo/human-figure-icon-graphic-as-user-login-button-on-white-keyboard.jpg?s=1024x1024&w=is&k=20&c=ZcuAC2Yjli7p0jCVQSSJV1sziyy34CiuWgPOzR3JfsA="
      />
      <CardContent>
   ...
   <Card sx={{ maxWidth: 345,marginLeft:20 }} className='background'>
      <CardMedia
        ...
        alt="employee"
        height="170"
        image="https://media.istockphoto.com/id/1353222468/photo/handshake-of-two-businessmen-who-enters-into-the-contract-to-protect-cyber-security-of.jpg?s=1024x1024&w=is&k=20&c=PonAMG2C2ugdNxWizz3cvXPwHL8GLRGGaFEiKBFBWj8="
      />
      <CardContent>
        <Typography gutterBottom variant="h5" component="div">
          Employee
